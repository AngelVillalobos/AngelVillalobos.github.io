...
function Alfil(sTP,x,y)
{
  ...
  this.brazoizq=new THREE.Mesh(new THREE.BoxGeometry(4,1,1),new THREE.MeshLambertMaterial({map:textura}));
  this.brazoder=new THREE.Mesh(new THREE.BoxGeometry(4,1,1),new THREE.MeshLambertMaterial({map:textura}));
