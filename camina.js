...
function Alfil(sTP,x,y)
{
  ...
  this.piernaizq=new THREE.Mesh(new THREE.BoxGeometry(1,1,9),new THREE.MeshLambertMaterial({map:textura}));
  this.piernader=new THREE.Mesh(new THREE.BoxGeometry(1,1,9),new THREE.MeshLambertMaterial({map:textura}));
